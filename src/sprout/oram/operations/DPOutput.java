...
public class DPOutput {
	...
	/*
	 * @Override public String toString() { String out = ""; if (secretC_P !=
	 * null) for (int i=0; i<secretC_P.length; i++) out += "secretC_P " + i +
	 * ": " + secretC_P[i] + "\n"; if (secretE_P != null) for (int i=0;
	 * i<secretE_P.length; i++) out += "secretE_P " + i + ": " + secretE_P[i] +
	 * "\n"; if (p != null) out += "p: " + p.toString() + "\n";
	 * 
	 * return out; }
	 */
}
