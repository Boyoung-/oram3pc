...
public class CopyOfReshuffle extends TreeOperation<BigInteger, Pair<BigInteger, List<Integer>>> {

	public CopyOfReshuffle() {
		super(null, null);
	}
	
  public CopyOfReshuffle(Communication con1, Communication con2) {
    super(con1, con2);
  }
