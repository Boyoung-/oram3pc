...
public class Communication {
	...
	public ECPoint readECPoint() {
		// TODO: This probably doesn't belong here. At least load curve from
		// crypto params
		byte[] msg = read();
	...
	// TODO: rather than implementing specific class read/writes support an
	// interface (e.g. serializable)
